package com.sir.library.banner;
...
import com.sir.library.banner.adapter.CBPageAdapter;
import com.sir.library.banner.holder.CBViewHolderCreator;
import com.sir.library.banner.listener.CBPageChangeListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(R.layout.include_view_pager, this, true);
